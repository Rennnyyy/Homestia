    ...
    <h3 brnAccordionHeader class="flex">
      <button brnAccordionTrigger data-slot="accordion-trigger" [class]="_computedTriggerClass()">
        ...
        <ng-icon
          ...
          class="pointer-events-none shrink-0 mr-2 group-aria-expanded/accordion-trigger:hidden!"
        />
        <ng-icon
          name="lucideChevronUp"
          data-slot="accordion-trigger-icon"
          class="pointer-events-none shrink-0 mr-2 group-aria-expanded/accordion-trigger:inline! group-aria-[expanded=false]/accordion-trigger:hidden!"
        />
      </button>
    </h3>
  `,
